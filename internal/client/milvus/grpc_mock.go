...
//   - ctx context.Context
func (_e *MockGrpc_Expecter) GetReplicateConfiguration(ctx interface{}) *MockGrpc_GetReplicateConfiguration_Call {
...
func (_e *MockGrpc_Expecter) GetReplicateInfo(ctx interface{}, sourceClusterID interface{}, targetPchannel interface{}) *MockGrpc_GetReplicateInfo_Call {
